  ...
  if(pathname.startsWith('/api/')) {
    ...
    if(pathname==='/api/export-excel'&&method==='POST') {
      ...
      try {
        ...
        const statusLbl={arabulucu:'Arabulucuya Başvurulacak',arabulucuBasvuruldu:'Arabuluculuğa Başvuruldu',davaacilacak:'Dava Açılacak',active:'İlk Derece',bam:'BAM',yargitay:'Yargıtay',infaz:'İnfaz',urgent:'Acil',closed:'Kapalı'};
